 ...
 * - Preservation of inline emotion tags like `[cười]`, `[thở dài]`, `[hắng giọng]`.
...
object SmartTextSegmenter {
    ...
    private const val PLACEHOLDER_PREFIX = "___AIBOOK_PH_"
     ...
     * - Attached closing quotes or brackets stay bound with the preceding sentence.
     */
    ...
    private val PLACEHOLDER_REGEX = Regex("___AIBOOK_PH_[AENT]_\\d+___")
