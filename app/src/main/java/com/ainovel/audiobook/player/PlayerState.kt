...
/**
 * Lifecycle states of the audio player subsystem.
 */
...
/**
 * Media metadata container for current audiobook track.
 */
...
/**
 * Immutable data state representing current playback status, timings, progress, and metadata.
 */
data class PlayerState(
    ...
    /**
     * Normalized progress ratio strictly bounded in [0.0f, 1.0f].
     */
    val progress: Float
